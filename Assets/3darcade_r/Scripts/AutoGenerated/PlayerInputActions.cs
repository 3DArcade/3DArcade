// GENERATED AUTOMATICALLY FROM 'Assets/3darcade_r/PlayerInputActions.inputactions'
...
namespace Arcade_r
{
    ...
    ""controlSchemes"": [
        ...
        public struct GlobalControlsActions
        {
            ...
            public GlobalControlsActions(@PlayerInputActions wrapper) { m_Wrapper = wrapper; }
        ...
        {
            private @PlayerInputActions m_Wrapper;
            public FPSControlsActions(@PlayerInputActions wrapper) { m_Wrapper = wrapper; }
        ...
        {
            private @PlayerInputActions m_Wrapper;
            public FPSMoveCabActions(@PlayerInputActions wrapper) { m_Wrapper = wrapper; }
        ...
        {
            private @PlayerInputActions m_Wrapper;
            public FPSMoveCabGrabbedActions(@PlayerInputActions wrapper) { m_Wrapper = wrapper; }
