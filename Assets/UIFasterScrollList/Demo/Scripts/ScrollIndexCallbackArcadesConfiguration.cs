...
public class ScrollIndexCallbackArcadesConfiguration : MonoBehaviour
{
    public Image image;
    public Text text;
    private int index = -1;
    ...
    void ScrollCellIndex(int idx)
    {
        ...
        if (text != null)
        {
            ...
            text.text = ArcadesConfigurationArcadeProperties.filteredSelectedModelList[idx].descriptiveName;
        }
        //if (image != null)
        //{
    ...
    public void ButtonClicked()
    {
        ...
        GameObject obj = GameObject.Find("ArcadesConfigurationUI");
        ArcadesConfigurationArcadeProperties filter = obj.GetComponent<ArcadesConfigurationArcadeProperties>();
