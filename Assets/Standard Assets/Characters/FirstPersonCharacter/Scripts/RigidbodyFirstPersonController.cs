...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class RigidbodyFirstPersonController : MonoBehaviour
    {
        ...
        public class AdvancedSettings
        {
            ...
            public float checkGroundForwardDistance = 0.1f;
        ...
        private void Update()
        {
            if (Cursor.lockState != CursorLockMode.Locked || pause)
            {
                return;
            }
        ...
        private void GroundCheck()
        {
            ...
            if (Physics.SphereCast(transform.position + cam.transform.forward * advancedSettings.checkGroundForwardDistance, m_Capsule.radius * (1.0f - advancedSettings.shellOffset), Vector3.down, out RaycastHit hitInfo, ((m_Capsule.height / 2f) - m_Capsule.radius) + advancedSettings.groundCheckDistance, Physics.AllLayers, QueryTriggerInteraction.Ignore))
            {
