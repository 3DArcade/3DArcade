...
namespace Arcade
{
    public class ModelImageSetup : MonoBehaviour
    {
        ...
        public void Setup(Texture2D tex, RenderSettings renderSettings, ModelProperties modelProperties, ModelComponentType modelComponentType)
        {
            ...
            Material tempMaterial = new Material(thisRenderer.sharedMaterial);
            string shaderName = tempMaterial.shader.name;
            ...
            {
                Component[] r = transform.parent.GetComponentsInChildren(typeof(Renderer));
                foreach (Renderer i in r)
                {
                    ...
                    if (id1 == id2)
                    {
                        ...
                        {
                            Material tempMaterial2 = new Material(i.material);
